...
import biology from './questions/biology.json';
...
class Biology extends React.Component {
    ...
    displayQuestions = (biology = this.state.biology, currentQuestion, nextQuestion, prevQuestion) => {
        //destructure the currentQuestionIndex
        let { currentQuestionIndex } = this.state;
        //check if our question array is empty
        if (this.state.biology !== undefined || this.state.biology !== null || (typeof this.state.biology !== Object
            && Object.keys(this.state.biology).length !== 0) || (typeof this.state.biology !== String
                && this.state.biology.trim().length !== 0)) {
            biology = this.state.biology;
            currentQuestion = biology[currentQuestionIndex];
            nextQuestion = biology[currentQuestionIndex + 1];
            prevQuestion = biology[currentQuestionIndex - 1];
            ...
            this.setState({
                ...
                nextQuestion,
                prevQuestion,
                numberofQuestion: biology.length,
                answer
            })
        }
    };
    componentDidMount() {
        const { biology, currentQuestion, nextQuestion, prevQuestion } = this.state;
        this.displayQuestions(biology, currentQuestion, nextQuestion, prevQuestion);
        this.startTimer();
    };
                ...
                <div id="biology">
                    <div id="bio_banner" className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <h1 className="heading_8">Quiz Portal</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* <footer className="container-fluid bio-footer">
                        <div className="row">
